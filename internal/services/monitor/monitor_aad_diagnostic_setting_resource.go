...
func resourceMonitorAADDiagnosticSettingCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	logs := expandMonitorAADDiagnosticsSettingsLogs(d.Get(log "github.com/sirupsen/logrus").(*pluginsdk.Set).List())
...
func resourceMonitorAADDiagnosticSettingRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if err := d.Set(log "github.com/sirupsen/logrus", flattenMonitorAADDiagnosticLogs(resp.Logs)); err != nil {
